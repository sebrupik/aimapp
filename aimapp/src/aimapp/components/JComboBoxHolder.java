...
public class JComboBoxHolder {
    ...
    public void addItem(String name, String source, JComboBox target) { this.addItem(name, source, target, true); }
    public void addItem(String name, String source, JComboBox target, boolean ps) { this.addItem(name, source, target, ps, false); }
    public void addItem(String name, String source, JComboBox target, boolean ps, boolean edit) { items.put(name, new enhancedJCBox(name, source, target, ps, edit)); }
    
    public void addItem(String name, java.sql.PreparedStatement prep_stat, JComboBox target) { this.addItem(name, prep_stat, target, true); }
    public void addItem(String name, java.sql.PreparedStatement prep_stat, JComboBox target, boolean ps) { this.addItem(name, prep_stat, target, ps, false); }
    public void addItem(String name, java.sql.PreparedStatement prep_stat, JComboBox target, boolean ps, boolean edit) { items.put(name, new enhancedJCBox(name, prep_stat, target, ps, edit)); }
...
class enhancedJCBox {
    ...
    public enhancedJCBox(String name, String source, JComboBox target, boolean ps, boolean edit) {
        this.name = name;
        this.source = source;
        this.target = target;
        this.ps = ps;
    ...
    public enhancedJCBox(String name, java.sql.PreparedStatement prep_stat, JComboBox target, boolean ps, boolean edit) {
        this.name = name;
    ...
    public enhancedJCBox(String name, String source, JComboBox target) {
